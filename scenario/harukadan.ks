...
[live2d_show name="haruka" time=0]

[live2d_opacity name="haruka" opacity=0 time=0]

[kc_position name="haruka" x=71 ]
...
[kc_hukidasi str="啊啦~老師!\r老師也來買東西嗎?" type="npc1"  name="haruka" paku=true ]
...
[kc_hukidasi str="是啊~美紀託我來買很多能拌飯的東西呢!" type="npc1"  name="haruka" paku=true ]

[kc_hukidasi str="\r玻玻玻璃罐" type="nar"]

[kc_hukidasi str="老師你看!這罐千導院家新推出的\r美莎希拌飯!" type="npc1"  name="haruka" paku=true ]
[kc_hukidasi str="看起來好好吃呢~" type="npc1"  name="haruka" paku=true ]
...
[kc_hukidasi str="啊~是美紀打來的呢" type="npc1"  name="haruka" paku=true ]
[kc_hukidasi str="為什麼要用這個鈴聲...!!" type="usr3" ]
[kc_stopSound name="dalu" ]
[kc_hukidasi str="摩西摩西~美紀?怎麼了嗎?" type="npc1"  name="haruka" paku=true ]

[kc_hidePic name="rengeroom" isBg="true"]

[kc_hukidasi str="遙香~~我等一下會帶很多好吃的飯回去喔~" type="npc1" x=25]
[kc_hukidasi str="都是剛採收下來新鮮的米做成的喔~" type="npc1" x=25]
[wait time=1000]
[kc_exp name="haruka" expName="miki_f03" ]
[kc_hukidasi str="哇~~好看起來好好吃~" type="npc1"  name="haruka" paku=true ]
[kc_hukidasi str="我也有買了很多拌飯料喔!" type="npc1"  name="haruka" paku=true ]
[kc_hukidasi str="嘿嘿~那就敬請期待~現在就飛回去摟" type="npc1" x=25]
[kc_hukidasi str="回來的時候注意安全，不要再撞到小鳥了喔!" type="npc1"  name="haruka" paku=true ]
[kc_hukidasi str="欸?!那次是...不會再撞到了啦~" type="npc1" x=25]
[kc_playSound name="se_touch_001"]
[kc_playSound name="bgm1" loop=true ]
[kc_showPic name="rengeroom" style="left: -13%;z-index: 2;height: 100%;", isBg="true"]

[kc_hukidasi str="那麼老師，我先走摟~" type="npc1"  name="haruka" paku=true ]
