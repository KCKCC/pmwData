...
;[live2d_new name="kaede"   width=1024 height=1024 left=-100 top=200 gltop=0.25  lip=true glscale=1.85 ]
...
;[live2d_new name="sadone"  width=1024 height=1024 left=-100 top=200 gltop=0.25  lip=true glscale=1.85 ]
;[live2d_new name="sakura"  width=1024 height=1024 left=-100 top=200 gltop=0.25  lip=true glscale=1.85 ]
...
;[live2d_new name="yuri"    width=1024 height=1024 left=-100 top=200 gltop=0.25  lip=true glscale=1.85 ]
...
[live2d_trans name = "anko" left=150 top=0 time=1000 ]
...
[kc_hukidasi str="哦！電腦開著呢..\r吼喉～" type="npc1" x=9 name="anko" paku=true]
[kc_hukidasi str="\r咖咑咖咑咖咑" type="nar" ]
[kc_hukidasi str="糟、糟糕了！\r不可以看那個\r資料夾！" type="usr2" ]
[kc_hukidasi str="欸？這個圖示....\r我也有玩過這個呢\r真懷念啊" type="npc1" x=9 name="anko" paku=true ]

[kc_hukidasi str="果然要選這個角色\r呢～看看我的實力\r吧！老師！" type="npc1" x=9 name="anko" paku=true ]
...
[kc_hukidasi str="嚇噫噫噫－－－" type="npc1" x=9 name="anko" paku=true ]


[live2d_expression name = "hinata" filenm="f02.exp.json" ]
[live2d_motion name = "hinata" filenm="m03.mtn" idle="ON" ]
[live2d_show name="hinata" left=200 top=0 time=1000 ]


[kc_hukidasi str="啊～～杏子學姊在\r偷玩老師的電腦！" type="npc2" x=53 name="hinata" paku=true ]
[kc_hukidasi str="日向，快點把杏子\r帶出去！" type="usr4" ]
[kc_hukidasi str="再不快點，那個資\r料夾就危險了！" type="usr4" ]
[kc_hukidasi str="\r日向也要玩～～～" type="npc1" x=53 name="hinata" paku=true ]
[live2d_trans name = "hinata" left=-150 top=-220 time=1000 ]
[live2d_trans name = "anko" left=-150 top=60 time=1000 ]
...
[wait time=600]
[kc_hukidasi str="我快贏了，不要爬\r上來啦啊啊！！\r嗚嗚嗯嗯～～" type="npc1" x=9 name="anko" paku=true ]
...
[kc_hukidasi str="姆咪～～\r杏子學姊救救我～" type="npc2" x=53 name="mumi" paku=true ]

[live2d_trans name = "anko" left=-150 top=120 time=1000 ]
[live2d_trans name = "hinata" left=-70 top=-160 time=1000 ]
[live2d_trans name = "mumi" left=-230 top=-160 time=1000 ]

[kc_hukidasi str="爬爬_爬爬_爬爬\r__爬爬_爬爬_爬爬\r爬爬_爬爬_爬爬" type="nar" ]

[live2d_expression name = "anko" filenm="f03.exp.json" ]
[wait time=600]
[kc_hukidasi str="努唔唔～～\r我能贏！我能贏！\r我能反殺！！" type="npc2" x=9 name="anko" paku=true ]
...
[kc_hukidasi str="妳們在玩什麼？！\r人家也要玩～❤❤❤" type="npc2" x=53 name="renge" paku=true ]
...
[live2d_trans name = "anko" left=-150 top=180 time=1000 ]
[live2d_trans name = "renge" left=-150 top=-280 time=1000 ]
[live2d_trans name = "hinata" left=-50 top=-100 time=1000 ]
[live2d_trans name = "mumi" left=-250 top=-100 time=1000 ]
...
[live2d_trans name = "hinata" left=250 top=0 time=1000 ]
...
[live2d_expression name = "renge" filenm="f04.exp.json" ]
[wait time=1000]
[kc_hukidasi str="嗯～真是好玩的遊\r戲呢～❤❤❤" type="npc1" x=53 name="renge" paku=true ]
[kc_hukidasi str="可是差不多要走了\r喔～❤" type="npc1" x=53 name="renge" paku=true ]
[kc_hukidasi str="對呀，杏子\r快沒時間了喔。" type="usr4" ]
[kc_hukidasi str="呼～～❤❤下次找\r明日葉一起玩吧❤" type="npc1" x=53 name="renge" paku=true ]

[live2d_opacity name="renge" opacity=0 time=200]
[wait time=200]
[live2d_hide name="renge" time=1000 ]

[live2d_show name="anko" left=-150 top=180 time=0]
[live2d_scale name = "anko" scaleX=1 scaleY=1 time=100 ]

[kc_hukidasi str="....看來我的\r穩定度還不夠呢。" type="npc1" x=9 name="anko" paku=true ]
[wait time=1000]
[live2d_trans name = "anko" left=250 top=0 time=1000 ]

[wait time=1000]

[kc_hukidasi str="疑？這裡怎麼放了\r一顆柚子，老師忘\r記拿了嗎？" type="npc1" x=53 name="anko" paku=true ]
[kc_hukidasi str="\r真是粗心呢～" type="npc1" x=53 name="anko" paku=true ]
