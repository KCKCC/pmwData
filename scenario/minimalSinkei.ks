...
[iscript]
kc.babylon.players = [
    { name: 'usr', maxClick: 2, wins: 0, point: 0,
      kikendo:0.3,
...
kc.endGame = () => {
    alert("da ja ke i hue ja la");
}
[endscript]
[kc_loadAllExp]

;https://raw.githubusercontent.com/KCKCC/pmwData/master/
[kc_prepareL2D name="a" url="C:\Users\KC\Desktop\R\pmwData\pwmData\models\anko\m\models\" modelFileName="m.json" ]
[kc_prepareL2D name="s" url="C:\Users\KC\Desktop\R\pmwData\pwmData\models\sakura\m\models\" modelFileName="m.json" ]

;load model 
[live2d_new name="a"    width=1024 height=1024 left=50% top=60% gltop=0.25  lip=true glscale=1.85 ]
[live2d_new name="s"    width=1024 height=1024 left=50% top=60% gltop=0.25  lip=true glscale=1.85 ]

[kc_addPic name="jyu" url="https://img.technews.tw/wp-content/uploads/2019/04/29120911/jeremy-thomas-99326-unsplash.jpg"]

[kc_showPic name="jyu" style="left: 0%;z-index: 2;height: 100%;", isBg="true"]

[live2d_show name="a" time=1 ]

[live2d_show name="s" time=1 ]
[kc_exp name="a" expName="sane_f04" ]

[kc_exp name="s" expName="sane_f04" ]
