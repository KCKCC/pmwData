...
;load model 
[live2d_new name="subaru"   width=1024 height=1024 gltop=0 top=55% left=150% lip=true glscale=1.85 ]
[live2d_new name="asuha"    width=1024 height=1024 gltop=0 top=55% left=150% lip=true glscale=1.85 ]
[live2d_new name="yuri"     width=1024 height=1024 gltop=0 top=55% left=150% lip=true glscale=1.85 ]
[live2d_new name="nozomi"   width=1024 height=1024 gltop=0 top=55% left=150% lip=true glscale=1.85 ]
...
[live2d_show name="subaru"  time=0]
[live2d_show name="asuha"   time=0]
[live2d_show name="nozomi"  time=0]
[live2d_show name="yuri"    time=0]
...
[kc_position name="subaru" x=15 ]
[kc_position name="asuha"  x=40 ]
[kc_position name="nozomi" x=60 ]
[kc_position name="yuri"   x=85 ]
...
[kc_hukidasi str="努唔唔。沒想到人\r會這麼多。" type="npc1"  name="yuri" paku=true ]
[kc_hukidasi str="要是有照時間來的\r話，就不會這樣了!" type="npc1"  name="yuri" paku=true]
[kc_hukidasi str="都是因為望一直跑\r去看秋季特賣會。" type="npc1"  name="yuri" paku=true ]
[kc_hukidasi str="百合還不是被中秋\r怪獸吸引過去..." type="npc1"  name="nozomi" paku=true ]
[kc_hukidasi str="剛剛的飾品，好可\r愛呢..." type="npc3"  name="subaru" ]
[kc_hukidasi str="好了，不要在分心\r了。" type="npc1"  name="asuha" paku=true ]
[kc_hukidasi str="打起精神來，現在\r要專心買煙火！" type="npc1"  name="asuha" paku=true ]

[live2d_expression name = "yuri" filenm="f05.exp.json" ]
[wait time=1000]

[kc_hukidasi str="啊! \r好的，明日葉\r學姊！" type="npc1"  name="yuri" paku=true ]
[kc_hukidasi str="嘻嘻~買東西就交給\r望喵吧。明日喵！" type="npc1"  name="nozomi" paku=true ]

[live2d_expression name = "asuha" filenm="f05.exp.json" ]
[wait time=600]

[kc_hukidasi str="...！！" type="npc3"  name="asuha" ]
...
[kc_hukidasi str="拜..拜託你們了喔。\r百合_望..望喵...." type="npc1"  name="asuha" paku=true ]
...
[kc_hukidasi str="那麼就開始吧！" type="npc1"  name="nozomi" paku=true ]

[live2d_expression name = "asuha" filenm="f02.exp.json" ]
[wait time=600]

[kc_position name="nozomi" x=70 ]
[kc_hukidasi str="這個" type="npc1"  name="nozomi" paku=true ]
[kc_position name="nozomi" x=20 ]
[kc_hukidasi str="這個\r這個" type="npc1"  name="nozomi" paku=true ]
[kc_position name="nozomi" x=60 ]
[kc_hukidasi str="這個\r這個\r這個" type="npc1"  name="nozomi" paku=true ]
[kc_position name="nozomi" x=80 ]
[kc_hukidasi str="\r那個那個" type="npc1"  name="nozomi" paku=true ]
[kc_position name="nozomi" x=40 ]
[kc_hukidasi str="\r這個這個這個" type="npc1"  name="nozomi" paku=true ]
...
[kc_hukidasi str="\r噫耶噫噫噫~" type="npc1"  name="asuha" paku=true ]
...
[kc_hukidasi str="\r唔!我也不能輸!!" type="npc1"  name="yuri" paku=true ]
[kc_hukidasi str="哈~~~" type="npc1"  name="yuri" paku=true ]
[kc_position name="yuri" x=30 ]
[kc_hukidasi str="\r這個" type="npc1"  name="yuri" paku=true ]
[kc_position name="yuri" x=50 ]
[kc_hukidasi str="\r這個" type="npc1"  name="yuri" paku=true ]
[kc_position name="yuri" x=70 ]
[kc_hukidasi str="\r這個" type="npc1"  name="yuri" paku=true ]
...
[kc_hukidasi str="\r還有這一整排~~" type="npc2"  name="yuri" paku=true ]
[kc_position name="yuri" x=80 ]
[wait time=1000]
[kc_position name="yuri" x=50 ]
[wait time=500]
...
[kc_hukidasi str="喔~~~那邊好像有\r奇怪的商品呢!" type="npc2"  name="nozomi" paku=true ]
...
[kc_hukidasi str="啊...啊...我的腰.." type="npc1"  name="asuha" paku=true ]

[live2d_expression name = "asuha" filenm="f10.exp.json" ]
[wait time=1000]

[kc_position name="asuha" x=52 y=64 r=14 ]
[wait time=100]

[kc_playSound name="suba_uwa" ]

[kc_position name="subaru" x=62 ]

[kc_hukidasi str="明日葉學姊，\r你沒事吧?!" type="npc2"  name="subaru" paku=true ]

[kc_position name="subaru" x=72 ]

[kc_position name="asuha" x=50 y=55 r=0 ]
...
[kc_hukidasi str="欸?!" type="npc2"  name="subaru" paku=true fontSize="2em" ]
...
[kc_position name="asuha" x=100 ]
[live2d_hide name = "asuha" time=1000 ]

[kc_hukidasi str="明日葉學姊，\r那邊是後門喔！" type="npc2"  name="subaru" paku=true ]

[kc_position name="subaru" x=100 ]
